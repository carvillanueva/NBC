...
@Component({
  ...
  template: `
    ...
    <div class="row sectionPadding row-cols-1 row-cols-md-2 align-items-md-center g-5 p-4">
        ...
        <div class="col">
            <div class="row row-cols-1 row-cols-sm-2 g-4">
                <div class="col d-flex flex-column gap-2">
                    <div class="iconBox fs-3 p-2 d-inline-flex align-items-center justify-content-center text-bg-primary headerBackground rounded-3">
